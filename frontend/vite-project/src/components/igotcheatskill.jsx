    ...
    <div className="anime-detail-container">
          <div className="anime-content">
            <div className="anime-header">
              <img src={`https://res.cloudinary.com/doqzxuxb1/image/upload/v1738658678/g8pgd3woetedkzwucupr.png`} alt={anime.title} className="anime-image" />
