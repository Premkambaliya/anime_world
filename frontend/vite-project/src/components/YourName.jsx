...
// import "./yourname.css"; // Importing CSS file

const YourName = () => {  // ⬅ Changed from "yourname" to "YourName"
    ...
    <div className="anime-detail-container">
      <div className="anime-content">
        <div className="anime-header">
          <img src={`https://res.cloudinary.com/doqzxuxb1/image/upload/v1738738751/fg7gc7tcfzc5ro0otbey.png`} alt={anime.title} className="anime-image" />
...
export default YourName;  // ⬅ Changed export name
