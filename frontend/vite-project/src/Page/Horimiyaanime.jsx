...
const Horimiya = () => {
  ...
  const [likes, setLikes] = useState(Number(localStorage.getItem("likes_horimiya")) || 0);
  const [shares, setShares] = useState(Number(localStorage.getItem("shares_horimiya")) || 0);
  ...
  const handleLike = () => {
    ...
    setLikes(newLikes);
    localStorage.setItem("likes_horimiya", newLikes);
  };
  ...
  const handleShare = () => {
    ...
    setShares(newShares);
    localStorage.setItem("shares_horimiya", newShares);
