...
const ClassroomOfTheElite = () => {
  ...
  const [likes, setLikes] = useState(Number(localStorage.getItem("likes_classroom")) || 0);
  const [shares, setShares] = useState(Number(localStorage.getItem("shares_classroom")) || 0);
  ...
  const handleLike = () => {
    ...
    setLikes(newLikes);
    localStorage.setItem("likes_classroom", newLikes);
  };
  ...
  const handleShare = () => {
    ...
    setShares(newShares);
    localStorage.setItem("shares_classroom", newShares);
