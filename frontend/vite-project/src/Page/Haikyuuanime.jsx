...
const Haikyuu = () => {
  ...
  const [likes, setLikes] = useState(Number(localStorage.getItem("likes_haikyuu")) || 0);
  const [shares, setShares] = useState(Number(localStorage.getItem("shares_haikyuu")) || 0);
  ...
  const handleLike = () => {
    ...
    setLikes(newLikes);
    localStorage.setItem("likes_haikyuu", newLikes);
  };
  ...
  const handleShare = () => {
    ...
    setShares(newShares);
    localStorage.setItem("shares_haikyuu", newShares);
