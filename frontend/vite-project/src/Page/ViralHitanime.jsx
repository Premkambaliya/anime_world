...
const ViralHit = () => {
  ...
  const [likes, setLikes] = useState(Number(localStorage.getItem("likes_viralhit")) || 0);
  const [shares, setShares] = useState(Number(localStorage.getItem("shares_viralhit")) || 0);
  ...
  const handleLike = () => {
    ...
    setLikes(newLikes);
    localStorage.setItem("likes_viralhit", newLikes);
  };
  ...
  const handleShare = () => {
    ...
    setShares(newShares);
    localStorage.setItem("shares_viralhit", newShares);
