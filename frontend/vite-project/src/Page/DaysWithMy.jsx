...
const DaysWithMy = () => {
  ...
  const [likes, setLikes] = useState(Number(localStorage.getItem("likes_dayswithmy")) || 0);
  const [shares, setShares] = useState(Number(localStorage.getItem("shares_dayswithmy")) || 0);
  ...
  const handleLike = () => {
    ...
    setLikes(newLikes);
    localStorage.setItem("likes_dayswithmy", newLikes);
  };
  ...
  const handleShare = () => {
    ...
    setShares(newShares);
    localStorage.setItem("shares_dayswithmy", newShares);
