...
const YourName = () => {
  ...
  const [likes, setLikes] = useState(Number(localStorage.getItem("likes_yourname")) || 0);
  const [shares, setShares] = useState(Number(localStorage.getItem("shares_yourname")) || 0);
  ...
  const handleLike = () => {
    ...
    setLikes(newLikes);
    localStorage.setItem("likes_yourname", newLikes);
  };
  ...
  const handleShare = () => {
    ...
    setShares(newShares);
    localStorage.setItem("shares_yourname", newShares);
